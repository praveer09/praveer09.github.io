...
description: 'Writing multithreaded RxJava programs using Schedulers and the subscribeOn and observeOn operators.'
pubDate: '2016-02-29'
tags: [java, reactive-programming, multi-threading]
redirectFrom:
  - '/technology/2016/02/29/rxjava-part-3-multithreading/'
---
...
An RxJava construct is composed of **one Observable followed by zero or more Operators followed by one Subscriber**.
...
**by default the execution of RxJava is blocking**.
...
[Part1]: /blog/rxjava-part-1-a-quick-introduction/
[Part2]: /blog/rxjava-part-2-creating-an-observable/
