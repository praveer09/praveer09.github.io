...
description: 'An introduction to functional programming and how it can improve the everyday work of object-oriented developers.'
pubDate: '2014-06-13'
tags: [java, functional-programming]
redirectFrom:
  - '/technology/2014/06/13/functional-programming-for-the-object-oriented-minds/'
---
...
language as **Java** but this is applicable to any other language.

Suppose you have to implement a functionality **_to filter from a list of products that have price less than 200_**.
...
**_what to do_** to **_how to do_**. Secondly, the **_mutable variable_** `filteredProducts` can cause problems when
...
You might have noticed that in this form of implementation the focus is on **_what to do_**. The **_how to do_** part
...
Moreover we can see that we could also do away with the **_mutability_**, thus reducing the chances of errors due to it.

## Summary

Thus we can see that using the functional programming paradigm we get to focus on **_what to do_** which, we as
