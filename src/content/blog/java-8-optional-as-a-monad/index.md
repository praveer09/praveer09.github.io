...
description: "Looking at Java 8's Optional through the lens of monads, and blending functional and object-oriented styles."
pubDate: '2016-07-14'
tags: [java, functional-programming]
redirectFrom:
  - '/java-8s-optional-as-a-monad-72c0bc844084'
  - '/technology/2016/07/14/java-8-optional-as-a-monad/'
---
...
- If location information cannot be found then return _No location found_.
...
[`orElse`][orElse] returns the _No location found_ only when the instance of Optional, upon which the method is called, is empty.
