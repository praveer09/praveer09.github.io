...
description: "Using Kotlin's language features to write concise, readable Test Data Builders for your tests."
pubDate: '2015-12-26'
tags: [kotlin, testing]
redirectFrom:
  - '/technology/2015/12/26/writing-test-data-builders-made-easy-with-kotlin/'
  - '/writing-test-data-builders-made-easy-with-kotlin-8d4409d87efd'
---

In this article I will be focusing on few features of [Kotlin][KotlinLang] that help in **writing
concise and readable code**. To explain the features, I will be using the concept of Test Data Builders,
...
By using **Test Data Builders**, which uses [Builder Pattern][BuilderPattern], the
construction and modification of a complex object can be made simple. We will see how the usage of builders leads to
better readability and maintainability and see **_how Kotlin makes it easy to write these builders_**.
