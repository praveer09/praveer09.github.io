...
description: "Extending existing interfaces without breaking code using Java 8's Function interface and its apply, compose and andThen methods."
pubDate: '2017-11-03'
tags: [java, functional-programming]
redirectFrom:
  - '/technology/2017/11/03/using-java-8-function-interface-for-extension/'
  - '/using-java-8s-function-interface-for-extension-1f6a788af8a4'
---
...
- The Function interface's `apply` method has been implemented in the `SomeInterface` using **_default methods_**
...
- The `SomeOtherInput` to `SomeInput` transformation logic lives inside the `toSomeInput()` instance method
  on `SomeOtherInput`. This logic is passed into `compose` method via **_method references_** feature introduced
