...
description: "A mental map of RxJava's many Observable factory methods and when to use each one."
pubDate: '2016-02-21'
tags: [java, reactive-programming]
redirectFrom:
  - '/technology/2016/02/21/rxjava-part-2-creating-an-observable/'
---
...
- Events are pushed to subscriber - [onNext][OnNext], [onError][OnError] and [onCompleted][OnCompleted] methods
  ...
  _ Zero, one or more than one calls to `onNext`
  _ Zero or only one call to either of `onCompleted` or `onError`
...
[Part3]: /blog/rxjava-part-3-multithreading/
